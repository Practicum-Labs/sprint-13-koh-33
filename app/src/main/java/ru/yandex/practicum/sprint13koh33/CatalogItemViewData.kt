package ru.yandex.practicum.sprint13koh33
...
import ru.yandex.practicum.sprint13koh33.databinding.VCatalogItemBinding
...
class CatalogItemViewHolder(
    ...
    fun bind(viewData: CatalogItemViewData) {
        ...
        binding.price.text = "${viewData.item.price / 100} ${binding.root.context.getString(R.string.valuta)}/${viewData.item.unit}"
